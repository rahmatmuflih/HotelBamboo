...
<body>
    ...
    <header id="header-area" class="fixed-top">
        ...
        <!--== Header Bottom Start ==-->
        <div id="header-bottom" style='background-color:#a5b636;z-index:1;'>
            <div class="container">
                <div class="row">
                    <!--== Logo Start ==-->
                    <div class="col-lg-4">
                        <a href="index.php" class="logo">
                            <img src="./assets/img/icon/Bamboo-admin-icon.png" alt="" style='width:250px;height:25px;'>
                        </a>
                    </div>
                    <!--== Logo End ==-->
                                    ...
                                    if (isset($_SESSION['user_id'])){
                                        ...
                                        if(mysqli_num_rows($hasil)>0){
                                            while($res=mysqli_fetch_array($hasil)){
                                                $nama = $res['nama_pengguna'];
                                            }
                                        }
                                        $nama_split=explode(' ',$nama);
                                        echo '
                                        <li><a style="cursor:pointer;">Hai, '.$nama_split[0].'</a>
                                            <ul>
